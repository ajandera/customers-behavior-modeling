...
\subsection{Dynamic Models} \label{subsec:dynamicModel}\\
...
\\
\subsection{Discrete-time Models} \label{subsec:discrete}\\
...
The shaded region in figure~\ref{Affordability of products} is the region of products dominated by product 1.
\begin{figure}[h!]
	\begin{center}
		\includegraphics[width=80mm]{affordability.png}
	\end{center}
	\caption{Products in the affordability-value plane~\cite{pantland}.}

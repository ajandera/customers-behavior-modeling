...
\begin{figure}[h!]
    \begin{center}
        \includegraphics[width=260]{flowchart_overview}
    \end{center}
...
\begin{figure}[h!]
    \begin{center}
        \includegraphics[width=160]{flowchart_vendor}
    \end{center}
...
\begin{figure}[h!]
    \begin{center}
        \includegraphics[width=150]{flowchart_psychology}
    \end{center}
...
\begin{figure}[h!]
    \begin{center}
        \includegraphics[width=150]{flowchart_loyalty}
    \end{center}
